...
1.  **デフォルト配列の変更**: QWERTY から **大西配列** へ変更しました。
2.  **SYM レイヤーの挙動修正**: 
...
| **Home** | LCTRL | (trans) | < | > | / | ? | | (trans) | LEFT | DOWN | UP | RIGHT | HOME |
| **Bottom** | LSHFT | UNLOCK | (trans) | (trans) | (trans) | (trans) | | (trans) | LA+L | PG_DN | PG_UP | LA+R | END |
